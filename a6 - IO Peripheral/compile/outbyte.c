...
#define OUTPERIPH_WRITE_OFFSET 0x00000010
#define OUTPERIPH_READSTATUS_OFFSET 0x00000010
void _outbyte(int c)
{
...
int readstatus() 
{
        ...
        int *p;   // Pointer to integer
        p = (int *)(OUTPERIPH_BASE + OUTPERIPH_READSTATUS_OFFSET); // Set pointer value directly
        return (*p); // Read the value from the address 
}
